    ...
    <div class="row mt-5">
        <div class="col-4">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/admin/chuyen-muc-new"
                        data-bs-toggle="" data-i18n="Email"><i data-feather="mail"></i><span data-i18n="Email">QUẢN LÝ
                            CHUYÊN MỤC</span></a>
                </li>
            </ul>
        ...
        <div class="col-4">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/admin/san-pham-new"
                        data-bs-toggle="" data-i18n="Email"><i data-feather="mail"></i><span data-i18n="Email">QUẢN LÝ
                            SẢN PHẨM</span></a>
                </li>
            </ul>
        ...
        <div class="col-4">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="/" data-bs-toggle=""
                        data-i18n="Email"><i data-feather="mail"></i><span data-i18n="Email">
                            VỀ TRANG CHỦ</span></a>
                </li>
            </ul>
        </div>
